...
<script>
   $(document).ready(function(){
       function show(x,u){
            $.post("newitem.jsp",{id:x,rel:u},function(data){
                        $("#page").append(data);
                    }
            );
       }
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper" id="rusmeen">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4" >
							...
							<div class="row"  >
                                                            ...
                                                            <%     
                                                                ...
                                                                ResultSet rs1=st.executeQuery("select * from product where  Block='Block' AND status=1 AND Subcategory='mobile' AND product_code NOT IN (select pcode from temp) limit 4");
                                                                while(rs1.next())
                                                                   { 
									...
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="seller/products/<%=pcode%>.jpg" alt="" style="height:300px;width:220px">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                                                            <button id="<%=pcode%>" rel="<%=subccode%>" ucode="<%=uscode%>" class="btn btn-primary">Add to cart </button>	
											</div>
										</div>
									</div>
                                                                     </div>
						...
						<!-- second section -->
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4" >
							<h3 class="heading-tittle text-center font-italic">New Brand Laptops</h3>
							<div class="row">
                                                            
                                                            <%  
                                                               ResultSet rs3=st.executeQuery("select * from product where Block='Block' AND status=1 AND Subcategory='laptop'");
                                                               while(rs3.next())
                                                                 { 
                                                                     String sn=rs3.getString("sn");
                                                                     String pcode=rs3.getString("product_code");
                                                                     String product_name=rs3.getString("product_name"); 
                                                                     String MRP=rs3.getString("MRP");
                                                                     String offer_price=rs3.getString("offer_price");
                                                                
                                                                %>
                                                                        <div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="seller/products/<%=pcode%>.jpg" alt="" style="width:300px;height:180px">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.jsp?id=<%=pcode%>" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                                                            <button id="<%=pcode%>"  class="btn btn-primary">Add to cart </button>	
											</div>
										</div>
									</div>
                                                                     </div>
					...
					<div class="side-bar p-sm-4 p-3">
							...
							<form action="#" method="post">
								...
								<input type="submit" value=" ">
                                            ...
                                            <div class="f-grid py-2">
                                                <h3 class="agileits-sear-head mb-3"><a href="checkout.jsp?id=<%=ucode%>">My Cart</a></h3>
							<div class="box-scroll">
                                                            <div class="scroll" id="cart">
                                                                <%    
                                                                String pcode=null;
                                                                ResultSet rs2=st.executeQuery("select * from temp where ucode='"+ucode+"'");
                                                                while(rs2.next()){
                                                                    pcode=rs2.getString("pcode");
                                                                    Connection cn2=DriverManager.getConnection("jdbc:mysql://localhost:3306/flipkart","root","");
                                                                    Statement st2=cn2.createStatement();
                                                                    ResultSet rs5=st2.executeQuery("select * from product where product_code='"+pcode+"'");
                                                                    while(rs5.next())
                                                                    { 
                                                                     String sn=rs5.getString("sn");
                                                                     String product_name=rs5.getString("product_name"); 
                                                                     String MRP=rs5.getString("MRP");
                                                                     String offer_price=rs5.getString("offer_price");
                                                                
                                                                %>
                                                                        <div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="seller/products/<%=pcode%>.jpg" alt="" style="width:50px;height:70px">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="checkout.jsp?id=<%=ucode%>" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
										</div>
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="checkout.jsp?id=<%=ucode%>"><%=product_name%></a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price"><%=offer_price%> rs/-</span>
												<del><%=MRP%> rs/-</del>
						...
						<div class="range border-bottom py-2">
							...
							<div class="w3l-range">
								<ul>
									<li>
                                                                            <a href='product.jsp?id=<%="0_10000"%>'>Under 10,000</a>
									</li>
									<li class="my-1">
										<a href='product.jsp?id=<%="10000_15000"%>'>10,000 - 15,000</a>
									</li>
									<li>
										<a href="product.jsp?id=<%="15000_20000"%>">15,000 - 20,000</a>
									</li>
									<li class="my-1">
										<a href='product.jsp?id=<%="20000_25000"%>'>20,000 - 25,000</a>
									</li>
									<li>
										<a href='product.jsp?id=<%="25000_30000"%>'>25,000 - 30,000</a>
									</li>
								</ul>
							</div>
						</div>
