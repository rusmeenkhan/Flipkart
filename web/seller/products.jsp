...
<script>
   $(document).ready(function(){
       $(".btn.btn-danger").click(function(){
           ...
           var x=$(this).attr("rel");
           var p=("c_"+u).trim();
           $.post("delete_product.jsp",{id:u,scode:x},function(data){
                $("#"+p).fadeOut(10);
           });
       });
   }); 
...
<script>
   $(document).on("click",".next",function(){
           var v=$(this).attr("id");
           var u=$(this).attr("rel");
           $.post("next.jsp",{id:v,rel:u},function(data){  
                  $("#rusmeen").html(data);
           });  
       });  
</script>
...
<script>
   $(document).ready(function(){
       $("#search").keyup(function(){
           var v=$(this).val();
           var u=$(this).attr("rel");
           $.post("search_product.jsp",{id:v,rel:u},function(data){
            $("#rusmeen").html(data);
           });  
       });
   }); 
					...
					<table class="timetable_sub">
						...
						<tbody>
                                                            ...
                                                            <%
                                                               ...
                                                               ResultSet rs1=st1.executeQuery("select * from product where Block='Block' AND seller_code='"+seller_code+"' limit 5");
                                                               while(rs1.next())
                                                                 { 
