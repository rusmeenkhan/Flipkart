...
<body>
	...
	<div class="agile-main-top">
						...
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							...
							<a class="nav-link" href="products.jsp">
								Manage Products
                                                ...
                                                <li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="Allplaces.jsp">
								MY Locations
							</a>
						</li>
        ...
        <div class="col-md-6" style="margin-left:300px;margin-top: 50px">                                   
            <form  method="post" action="insertlocation.jsp">
                
                    <h1>Add Location</h1>
                    <div class="form-group">
                            <label class="col-form-label">Location</label>
                            <input type="text" class="form-control" placeholder=" " name="Location" required="required">
                     </div>
                    <div class="form-group">
                             <label class="col-form-label">pincode</label>
                             <input type="text" class="form-control" placeholder=" " name="pincode" required="required">
                    </div>
                    <div class="form-group">
