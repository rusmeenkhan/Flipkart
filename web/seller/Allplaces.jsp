...
<script>
   $(document).ready(function(){
       $(".btn.btn-danger").click(function(){
           var v=$(this).attr("id");
           var u=v.substring(v.indexOf("_")+1);
           var x=$(this).attr("rel");
           var p=("c_"+x).trim();
           $.post("delete_location.jsp",{scode:u,pin:x},function(data){
                $("#"+p).fadeOut(10);
           });
       });
   }); 
					...
					<table class="timetable_sub">
						...
						<tbody>
                                                            ...
                                                            <%
                                                               ...
                                                               ResultSet rs1=st1.executeQuery("select * from Location where  scode='"+scode+"'");
                                                               while(rs1.next())
                                                                 {
                                                            ...
                                                            %>
                                                            <tr class="rem1" id="c_<%=pincode%>">
                                                                <td class="invert"><%=Location%></td>
                                                                <td class="invert"><%=pincode%></td>
                                                                <td class="invert"><button id="d_<%=scode%>" rel="<%=pincode%>" class="btn btn-danger" style="background-color:red;color:white;border:none">Delete Location</button></td>
                                                                <td class="invert"><a href="edit_Location.jsp?id=<%=pincode%>&&scode=<%=scode%>" class="btn btn-danger" style="background-color:blue;color:white;border:none">Edit Location</a></td>
                                                            </tr>
                                                           <% 
                                                              }
                                                            %>
