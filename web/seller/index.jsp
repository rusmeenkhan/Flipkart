...
<body>
	...
	<div class="agile-main-top">
		...
		<div class="container">
						...
						<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
							...
							<a class="nav-link" href="places.jsp">
								Manage My Places
                                                ...
                                                <li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
                                                    <a class="nav-link" href="Quantity.jsp?id=<%=scode%>">
								Increase Quantity
							</a>
						</li>
            ...
            <form id="regForm" method="post" action="insertproduct.jsp">
                <h1>Add Product</h1>
  <!-- One "tab" for each step in the form: -->
                    <div class="tab">
                            ...
                            <div class="form-group">
                                     ...
                                     <select name="category" class="control-label form-control"  id="cat"><option selected="" disabled></option>
                                       <%   
                                            try{
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                        Connection cn1=DriverManager.getConnection("jdbc:mysql://localhost:3306/Flipkart","root","");
                                                        Statement st1=cn1.createStatement();
                                                        ResultSet rs1=st1.executeQuery("select * from category where status=1");
                                                        while(rs1.next())
                                                             { 
                                      ...
                                      <div class="form-group">
                                             ...
                                             <select id="subcat" name="subcategory" class="control-label form-control">
                                    ...
                                    <div class="form-group">
                                             ...
                                             <select name="size" class="control-label form-control" id="size">
                                                 <option disabled=""></option>
                    ...
                    <div class="tab">
                          ...
                          <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" placeholder=" " name="no_of_item" required="">
                          </div>
                          <div class="form-group">
                                   <label class="col-form-label">MRP</label>
                                   <input type="text" class="form-control" placeholder=" " name="MRP" required="">
                          </div>
                          <div class="form-group">
                                   <label class="col-form-label">Offer price</label>
                                   <input type="text" class="form-control" placeholder=" " name="offer_price" required="">
                          </div>    
                          <div class="form-group">
                                    <label class="col-form-label">Discount</label>
                                    <input type="text" class="form-control" placeholder=" " name="Discount" required="">
                          </div> 
                        <div class="form-group">
                                    <label class="col-form-label">Specifications</label>
                                     <textarea name="Specification" style="width:790px ;height:200px" class="form-control">
                                     </textarea>
                        </div> 
