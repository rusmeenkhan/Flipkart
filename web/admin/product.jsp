...
<script>
   $(document).ready(function(){
       $("#search").keyup(function(){
           var v=$(this).val();
           $.post("search_product.jsp",{id:v},function(data){  
                  $("#rusmeen").html(data);
           });  
       });
   }); 
...
<script>
   $(document).on("click",".next",function(){
           var v=$(this).attr("id");
           $.post("next.jsp",{id:v},function(data){  
                  $("#rusmeen").html(data);
           });  
       });  
</script>
...
<script>
            $(document).on("click",".btn.btn-danger",function(){
                    ...
                    var x=$(this).attr("rel");
                   // alert(x);
                   $.post("pblock.jsp",{id:v,rel:x},function(data){   
					...
					<table class="timetable_sub">
						...
						<tbody>
                                                            ...
                                                            <%
                                                               ...
                                                               ResultSet rs1=st.executeQuery("select * from product limit 5");
                                                               while(rs1.next())
                                                                 { 
