		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="checkout-left">
				<div class="address_form_agile mt-sm-8 mt-1">
                                    ...
                                    ResultSet rs1=st.executeQuery("select * from category where ccode='"+ccode+"' AND status=1");
                                    while(rs1.next())
                                         { 
                                    %>
                                    <form action="update_cat.jsp?id=<%=ccode%>" method="post" class="creditly-card-form agileinfo_form" style="margin-left: 300px">
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="col-md-8">
									<div class="controls form-group">
                                                                            <label>category</label>
                                                                            <input class="billing-address-name form-control"  value="<%=rs1.getString("cname")%>" type="text" name="category" placeholder="Full Name" required="">
									</div>  
                                                                        <div class="controls form-group">
