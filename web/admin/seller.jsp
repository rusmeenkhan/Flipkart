...
<script>
   $(document).ready(function(){
       $("#search").keyup(function(){
           var v=$(this).val();
           $.post("search_seller.jsp",{id:v},function(data){  
                  $("#rusmeen").html(data);
                  $("#new").hide();
           });  
       });
...
<script>
   $(document).on("click",".next",function(){
           var v=$(this).attr("id");
           $.post("next_seller.jsp",{id:v},function(data){  
                  $("#rusmeen").html(data);
           });  
       });  
</script>
...
<script>
            $(document).on("click",".btn.btn-danger",function(){
                    ...
                    var x=$(this).attr("rel");
                   // alert(x);
                   $.post("sblock.jsp",{id:v,rel:x},function(data){   
        ...
        <script>
            $(document).ready(function(){
                $(".Approve").change(function(){
                  var x = $('.Approve option:selected').text();
                   var v = $(this).attr("id");
                    //alert(x);
                    $.post("approve.jsp",{id:v,rel:x},function(data){
	...
	<!-- checkout page -->      
            <%
                int ic=0;
                 ...
                 ResultSet rs=st.executeQuery("select * from seller where status=1");
                 if(rs.next())
                     { 
            %>
		...
		<div class="container py-xl-4 py-lg-2">
					...
					<table class="timetable_sub">
						...
						<tbody>
                                                            ...
                                                            <%  
                                                               ...
                                                               ResultSet rs2=st.executeQuery("select * from seller where status=1 limit 2");
                                                               while(rs2.next())
                                                                 { 
           ...
           <%
            ...
            %>
            <div class="privacy py-sm-5 py-4" id="new">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<span>Pending Se</span>llers
			</h3>
			  <div class="table-responsive">
					<table class="timetable_sub">
						<thead>
						...
						<tbody>
                                                            ...
                                                            <%
                                                               ...
                                                               ResultSet rs1=st1.executeQuery("select * from seller where status=0");
                                                               while(rs1.next())
                                                                 { 
                                                                     String sn=rs1.getString("sn");
                                                                     String sname=rs1.getString("sname"); 
                                                                     String Company=rs1.getString("Company");
                                                                     String scode=rs1.getString("scode");
								...
								<td class="invert"><%=sn%></td>
                                                                ...
                                                                <td class="invert"><%=scode%></td> 
                                                                <td class="invert">
                                                                    <select name="status" class="Approve" id="<%=scode%>">
