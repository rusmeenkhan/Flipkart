...
<body>
	...
	<!-- middle section -->
        ...
        <div class="col-md-6" style="margin-left: 400px;margin-top: 50px">
            <form action="addsize.jsp" method="post">
                    <div class="form-group">
                                     <label class="col-form-label">Select Subcategory</label>
                                     <select name="Subcategory" class="control-label form-control"  id="cat"><option selected="" disabled></option>
                                       <%   
                                            try{
                                                        Class.forName("com.mysql.jdbc.Driver");
                                                        ...
                                                        while(rs1.next())
                                                             { 
                                                                String cname=rs1.getString("Subcategory");
                                                                String ccode=rs1.getString("subccode");
                                        %>
                    ...
                    <div class="form-group">
                       <label class="col-form-label">Enter Size</label>
