  ...
  <script>
   $(document).ready(function(){
       $(".btn.btn-danger").click(function(){       
           var v=$(this).attr("id"); 
           var p="d_"+v;
            $.post("delete_cat.jsp",{id:v},function(data){
                $("#"+p).fadeOut(10);
             });
       });
   }); 
					...
					<table class="timetable_sub">
						...
						<tbody>
                                                            ...
                                                            <%
                                                               ...
                                                               while(rs1.next())
                                                                 { 
                                                                     String category_name=rs1.getString("cname");
                                                                     String category_code=rs1.getString("ccode");                                                                   
                                                            %>
                                                            <tr class="rem1" id="d_<%=category_code%>">
								
                                                                <td class="invert"><%=category_name%></td>
                                                                <td class="invert"><%=category_code%></td>
                                                                <td class="invert"><button id="<%=category_code%>" class="btn btn-danger" style="background-color:red;color:white;border:none">Delete Category</button></td>
                                                                <td class="invert"><a href="edit_cat.jsp?id=<%=category_code%>" class="btn btn-primary" style="background-color:blue;color:white;border:none">Edit Category</a></td>
                                                            </tr>
                                                           <% 
                                                              }
                                                            %>
