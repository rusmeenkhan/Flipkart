...
<script>
   $(document).ready(function(){
       $(".btn.btn-danger").click(function(){       
           var v=$(this).attr("id"); 
           var p="d_"+v;
           $.post("delete_subcat.jsp",{id:v},function(data){
             $("#"+p).fadeOut(10);   
             });
       });
   }); 
					...
					<table class="timetable_sub">
						...
						<tbody>
                                                            ...
                                                            <%
                                                               ...
                                                               ResultSet rs1=st1.executeQuery("select * from subcategory where status=1");
                                                               while(rs1.next())
                                                                 { 
                                                                     String Subcategory=rs1.getString("Subcategory");
                                                                     String subccode=rs1.getString("subccode");                                                                   
                                                            %>
                                                            <tr class="rem1" id="d_<%=subccode%>">
								
                                                                <td class="invert"><%=Subcategory%></td>
                                                                <td class="invert"><%=subccode%></td>
                                                                <td class="invert"><button id="<%=subccode%>" class="btn btn-danger" style="background-color:red;color:white;border:none">Delete Category</button></td>
                                                                <td class="invert"><a href="edit_subcat.jsp?id=<%=subccode%>" class="btn btn-primary" style="background-color:blue;color:white;border:none">Edit Category</a></td>
                                                            </tr>
                                                           <% 
                                                              }
                                                            %>
