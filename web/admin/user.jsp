...
<script>
   $(document).on("click",".next",function(){
           var v=$(this).attr("id");
           $.post("next_user.jsp",{id:v},function(data){  
                  $("#rusmeen").html(data);
           });  
       });  
</script>
...
<script>
   $(document).ready(function(){
       $("#search").keyup(function(){
           var v=$(this).val();
           $.post("search_user.jsp",{id:v},function(data){  
                  $("#rusmeen").html(data);
           });  
       });
   }); 
        ...
        <script>
            $(document).ready(function(){
                $(".btn.btn-danger").click(function(){
                    ...
                    var x=$(this).attr("rel");
                   // alert(x);
                   $.post("block.jsp",{id:v,rel:x},function(data){   
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.jsp" class="font-weight-bold font-italic">
							<img src="images/logo2.png" alt=" " class="img-fluid">Elecshop Admin
						</a>
					</h1>
				</div>
				<!-- //logo -->
					...
					<table class="timetable_sub">
						...
						<tbody>
                                                            ...
                                                            <%
                                                               ...
                                                               ResultSet rs1=st.executeQuery("select * from user limit 5");
                                                               while(rs1.next())
                                                                 { 
