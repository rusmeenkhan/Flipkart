						...
						<!-- search -->
                           ...
                           <div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
                                <div class="wthreecartaits wthreecartaits2 cart cart box_1" >
                                    ...
                                    <%
                                        int product=0;
                                        ResultSet rs6=st.executeQuery("select count(*) from temp where ucode='"+ucode+"'");
                                        if(rs6.next()){
                ...
                <div class="agileinfo-ads-display col-lg-9">
                    <div class="wrapper" id="rusmeen">
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4" >
                            <h3 class="heading-tittle text-center font-italic">My Wishlist</h3>
                                <div class="row"  >
                                    <div class="row"  id="page_<%=ucode%>">
                                        <%     
                                            int ic=0;
                                            ...
                                            ResultSet rs1=st1.executeQuery("select * from product where  Block='Block' AND status=1 AND product_code IN (select pcode from wishlist where ucode='"+ucode+"')  limit 3");
                                            while(rs1.next())
                                               { 
                                                ...
                                                <div class="col-md-4 product-men mt-5" id="<%=pcode%>_d">
                                                    <div class="men-pro-item simpleCart_shelfItem">
                                                            <div class="men-thumb-item text-center">
                                                                <img src="seller/products/1_<%=pcode%>.jpg" alt="" style="width:220px;height:290px">
                                                                    <div class="men-cart-pro">
                                                                            ...
                                                                            <div class="item-info-product text-center border-top mt-4">
                                                                                ...
                                                                                <%
                                                                                 ...
                                                                                 if(No_of_item>0){ 
                                                                                    ResultSet rs9=st2.executeQuery("select * from temp where pcode='"+pcode+"' AND ucode='"+ucode+"'");
                                                                                    if(rs9.next()){
                                                                                    %>
                                                                                    ...
                                                                                    %>
                                                                                        <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                                                            <button id="p_<%=pcode%>" rel="Add" ucode="<%=ucode%>" class="btn btn-primary" >Add to cart </button>	
                                                                                        </div>
                                                                                    <%
                                                                                    }
                                                                                }
